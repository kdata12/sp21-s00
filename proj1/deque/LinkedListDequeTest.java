...
public class LinkedListDequeTest {
    ...
    public void LinkedListIsEmpty() {
        LinkedListDeque<Integer> expected = new LinkedListDeque<Integer>();
        LinkedListDeque<Integer> test = new LinkedListDeque<Integer>();

        assertEquals(expected.isEmpty(), test.isEmpty());
    ...
    @Test
    public void bigOperations() {

        LinkedListDeque<Integer> expected = new LinkedListDeque<Integer>();

        int N = 100_000;
        for (int i = 0; i < N; i ++) {
            int operationNumber = StdRandom.uniform(1, 6);
